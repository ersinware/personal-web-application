...
<div class="for-small-screen wrapper p-f b-0 p-c-h z-index-3 w-100 max-w-phone color-background">
    <aside class="bottom-bar b-box flex a-i-c j-c-s-e color-background-second b-shadow">
        <button class="wrapper-item grid j-i-c"
            ...
            <span class="text text-1 l-h-1 color-text-second f-w-500">Menu</span>
        </button>

        <a href="/portfolio"
           class="wrapper-item grid j-i-c"
           aria-label="Portfolio">
            ...
            <p class="text text-1 l-h-1 color-text-second f-w-500">Portfolio</p>
        </a>
        ...
        <a href="/blog"
           ...
           aria-label="Blog">
            ...
            <p class="text text-1 l-h-1 color-text-second f-w-500">Blog</p>
        </a>
        ...
        <a href="/contact"
           ...
           aria-label="Contact">
            ...
            <p class="text text-1 l-h-1 color-text-second f-w-500">Contact</p>
        </a>
    </aside>
</div>
