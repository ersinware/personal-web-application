<script>
    ...
    import ModalMenu from "$lib/components/app/layout/small-screen/modal/ModalMenu.svelte";
    import {EVENT_ADD_LISTENER_SMALL_SCREEN, EVENT_OPEN_MODAL} from "$lib/js/client/common/event.common.client.js";
                ...
                new CustomEvent(
                    EVENT_ADD_LISTENER_SMALL_SCREEN,
                    {
                        detail: {
                            ...
                            f: () => {
                                document
                                    .querySelectorAll('.bottom-bar a.wrapper-item')
                                    .forEach(a => a.addEventListener('click', onLinkClick))

                                document
                                    .querySelector('.bottom-bar button')
                                    .addEventListener(
                                        'click',
                                        async event => {
...
<div class="for-small-screen wrapper p-f b-0 p-c-h z-index-3 w-100 max-w-phone color-background">
    <aside class="bottom-bar b-box flex a-i-c j-c-s-e color-background-second b-shadow">
        <button class="wrapper-item grid j-i-c"
                aria-label="Menu">
            ...
            <span class="text-1 l-h-1 color-text-second f-w-500">Menu</span>
        </button>

        <a href="/portfolio"
           class="wrapper-item-page wrapper-item grid j-i-c"
           aria-label="Portfolio">

            <svg class="icon"
                 class:icon-active="{$page.url.pathname === '/portfolio'}"
                 xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="text-1 l-h-1 color-text-second f-w-500">Portfolio</p>
        </a>
        ...
        <a href="/blog"
           ...
           aria-label="Blog">
            ...
            <svg class="icon-blog icon"
                 class:icon-active="{$page.url.pathname === '/blog'}"
                 xmlns="http://www.w3.org/2000/svg"
                 viewBox="0 0 512 512">
            ...
            <p class="text-1 l-h-1 color-text-second f-w-500">Blog</p>
        </a>
